...
PreparedStatement pst;
    ...
    public void ReturnUpdate(){
        String sql="insert into Return(Student_ID,Name,FName,Course,Branch,Year,Semester,Book_ID,BName,Edition,Publisher,Price,Pages,DIR,DOR) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            pst=conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 102, 255), 4, true), "Return Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 36), new java.awt.Color(0, 204, 102))); // NOI18N
        ...
        setSize(new java.awt.Dimension(876, 576));
                    ...
                    if(rs.next()){
                       ...
                       // String add4=rs.getString(" Branch");
                        ...
                        pst.close();
                         ...
                         JOptionPane.showMessageDialog(null, "Book Id Not Issue With these Student ID");
                    }
                }catch(Exception e){
                    JOptionPane.showMessageDialog(null,e);
                }finally{
